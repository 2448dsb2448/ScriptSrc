...
<div id="scripts_div" hidden="hidden">
    ...
    <h4 onclick="ToggleElement('footprints_lite_div')">Footprints Lite</h4>

    <div id="footprints_lite_Div">
        <a href="Shared/Scripts/Footprints_Lite/Footprints_Lite_Current.user.js">Click here to download the script</a>

        <p></p>
    </div>

    <h4 onclick="ToggleElement('footprints_Mini_div')">Footprints Mini - FOR TRAINING</h4>

    <div id="footprints_Mini_Div">
        <a href="Shared/Scripts/Footprints_Mini/Footprints_Mini_Current.user.js">Click here to download the script</a>
    ...
    <h4 onclick="ToggleElement('SA_Search_on_Enter')">ServAssure Search on Enter</h4>

    <div id="arris_3450_password">
        <a href="Shared/Scripts/SA_Search_on_Enter/SA_Search_on_Enter_Current.user.js">Click here to download the script</a>
